...
PARAM = {
    ...
    'axon_shell_color_mean': 60.0,              'axon_shell_color_std': 10.0, # Цвет оболочек аксона
    ...
    'mitohondrion_cristae_color_mean': 113.0,   'mitohondrion_cristae_color_std': 4.8, # Цвет внутри крист

    'psd_back_color_mean': 60.0,                'psd_back_color_std': 7.5, # Цвет основной части PSD
    'psd_addcolor_mean': 65.0,                  'psd_addcolor_std': 15.0, # Цвет метелки PSD
    'psd_centerline_color_mean': 100.0,         'psd_centerline_color_std': 10.0, # Цвет нитки поверх PSD

    'vesicles_shell_color_mean': 85.8,          'vesicles_shell_color_std': 13.0, # Цвет оболочки везикул
    'vesicles_back_color_mean': 127.0,          'vesicles_back_color_std': 12.5, # Цвет внутри везикул
